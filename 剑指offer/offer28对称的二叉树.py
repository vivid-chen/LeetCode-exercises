...
def TreeIsSymmetrical(root1,root2):
    ...
    if root1.val != root2.val:
        return  False
    return TreeIsSymmetrical(root1.left,root2.right) and TreeIsSymmetrical(root1.right,root2.left)



root = tree.build_binary_tree([8,6,6,5,7,7,4])
PrintTreeFromTopToDown(root)
print(TreeIsSymmetrical(root,root))